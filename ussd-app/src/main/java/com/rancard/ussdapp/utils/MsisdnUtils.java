...
public class MsisdnUtils {
    ...
    public static String phoneNumberFormat(String msisdn , String sessionId){
        log.debug("["+ sessionId +"] Formatting msisdn: " + msisdn);
    ...
    public static String resolveNetwork(String msisdn , String sessionId) {
        msisdn = isValidPhoneNumber(msisdn) ? phoneNumberFormat(msisdn,sessionId) : msisdn;
